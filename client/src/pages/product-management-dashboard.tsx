    ...
    <div className="flex-1 p-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Operational hub for efficient product data management
        </p>
      </div>
              ...
              {metrics?.enrichmentProgress?.map((channel, index) => (
                <div key={index}>
                  <div className="flex justify-between text-sm">
                    ...
                    <span>
                      {channel.progress}/{channel.total}
                    </span>
                  </div>
                  <Progress
                    value={(channel.progress / channel.total) * 100}
                    className="h-2"
                  />
                </div>
              ))}
                ...
                {tasks?.map((task) => (
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      <div
                        className={`w-2 h-8 rounded ${getTaskPriorityColor(task.priority)}`}
                      ></div>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <Link href={`/products/${task.productId}/edit`}>
                        <Button
                          size="sm"
                          data-testid={`button-edit-${task.productId}`}
                        >
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-2">
                        ...
                        {activity.productName && (
                          <Link
                            href={`/products/${activity.productId}/edit`}
